...
function Wishlist() {
  ...
  return (
    <>
      <div data-aos="fade-right wishmain">
        <div className="wishmain container d-flex justify-content-center align-items-center">
          <h5 className="fw-bold fs-1">
            WISHLISTS <FontAwesomeIcon className="text-danger" icon={faHeart} />{" "}
          </h5>
        </div>
        <hr className="tabs" />
        <Link className="ms-5 backhoe" to={"/"}>
          <button className="btn btn-dark mt-4 ">
            <FontAwesomeIcon className="me-2" icon={faArrowLeft} /> back to home
          </button>
        </Link>
        <div className="  produt-listing produt-listing1 mt-5 ">
          {wishlistItems?.length > 0 ? (
            ...
            <div className="ms-auto img me-auto mt-4">
              <img
